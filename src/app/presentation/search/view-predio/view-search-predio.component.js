...
var ViewSearchPredioComponent = (function (_super) {
    __extends(ViewSearchPredioComponent, _super);
    function ViewSearchPredioComponent(messagingService, proceduresManager, tasksManager, router, activatedRoute, geoJsonService, rolesManager, cuencaService) {
    ...
    ViewSearchPredioComponent.prototype.ngOnInit = function () {
    ...
    ViewSearchPredioComponent.prototype.getTask = function () {
        var _this = this;
    ...
    ViewSearchPredioComponent.prototype.getComments = function () {
        var _this = this;
    ...
    ViewSearchPredioComponent.prototype.insertComment = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    ViewSearchPredioComponent.prototype.setDataType = function () {
    ...
    ViewSearchPredioComponent.prototype.getData = function () {
        var _this = this;
        switch (this.task.details.type.id + '') {
            case '1':
    ...
    ViewSearchPredioComponent.prototype.downloadData = function (data) {
        var _this = this;
    ...
    ViewSearchPredioComponent.prototype.getShapeFile = function (geoJson) {
    ...
    ViewSearchPredioComponent.prototype.approveTask = function () {
        var _this = this;
        var componente = this;
    ...
    ViewSearchPredioComponent.prototype.approveTaskOtros = function () {
        var _this = this;
        this.tasksManager.approveTask(this.task.id)
            .then(function () {
            _this.tasksManager.clearObjects();
    ...
    ViewSearchPredioComponent.prototype.approveTaskBuenasP = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.tasksManager.approveTask(this.task.id)
    ...
    ViewSearchPredioComponent.prototype.approveTaskSigGeneracion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.mapaverif = false;
            this.documents.forEach(function (documento) {
                if (documento.id_sub_type === 15) {
    ...
    ViewSearchPredioComponent.prototype.approveTaskConceptoCoordinacion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
            this.documents.forEach(function (documento) {
                if (documento.id_sub_type === 27) {
    ...
    ViewSearchPredioComponent.prototype.approveTaskConceptoJuridico = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
            this.documents.forEach(function (documento) {
                if (documento.id_sub_type === 28) {
                    componente.conceptoCoor = true;
                }
            });
            if (this.conceptoCoor) {
    ...
    ViewSearchPredioComponent.prototype.approveTaskMinutaDireccion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
            this.documents.forEach(function (documento) {
                if (documento.id_sub_type === 16) {
                    componente.conceptoCoor = true;
                }
            });
            if (this.conceptoCoor) {
    ...
    ViewSearchPredioComponent.prototype.approvePropietarioFirma = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
            this.documents.forEach(function (documento) {
                if (documento.id_sub_type === 32) {
                    componente.conceptoCoor = true;
                }
            });
            if (this.conceptoCoor) {
    ...
    ViewSearchPredioComponent.prototype.approveTaskProgrammer = function () {
        var _this = this;
        var componente = this;
    ...
    ViewSearchPredioComponent.prototype.refreshFiles = function ($event) {
        this.obtenerArchivos();
    };
    //////devolver Tarea
    ViewSearchPredioComponent.prototype.decline = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    ViewSearchPredioComponent.prototype.declineOtros = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    ViewSearchPredioComponent.prototype.eliminarDoc = function (id, type) {
        var _this = this;
    ...
    ViewSearchPredioComponent.prototype.obtenerArchivos = function () {
        var _this = this;
        this.documents = null;
    ...
    ViewSearchPredioComponent.prototype.returnName = function (nameFile) {
        var nombre = nameFile.split('_');
        return nombre[1];
    };
    ViewSearchPredioComponent.prototype.eventoProgramar = function ($event) {
    ...
    ViewSearchPredioComponent.prototype.solicitarCertificado = function () {
        var _this = this;
    ...
    ViewSearchPredioComponent.prototype.enviarCertificado = function () {
        var component = this;
    ...
    ViewSearchPredioComponent.prototype.cancelarTarea = function () {
    ...
    ViewSearchPredioComponent.prototype.getRoles = function () {
        var component = this;
    ...
    ViewSearchPredioComponent.prototype.getUsers = function () {
        var component = this;
        this.users = [];
        return new Promise(function (resolve) {
    ...
    ViewSearchPredioComponent.prototype.enviarTareaCoordinadorA = function () {
        var _this = this;
    ...
    return ViewSearchPredioComponent;
}(base_component_1.BaseComponent));
ViewSearchPredioComponent = __decorate([
    core_1.Component({
...
exports.ViewSearchPredioComponent = ViewSearchPredioComponent;
//# sourceMappingURL=view-search-predio.component.js.map