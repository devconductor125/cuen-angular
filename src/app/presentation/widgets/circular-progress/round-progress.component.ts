import {Component, EventEmitter, Input, NgZone, OnChanges, Output, Renderer, ViewChild,} from '@angular/core';
...
@Component({
  selector: 'cuenca-round-progress',
  template: `
    <div style="height: 50px">
      ...
      <div class="numbercircles">{{current | number: '1.0-0'}}%</div>
    </div>
  `,
  host: {
    'role': 'progressbar',
