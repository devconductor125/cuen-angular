...
@Component({
  selector: 'cuenca-drag-and-drop-centro-costos',
  templateUrl: './drag-and-drop-centro-costos.component.html',
  styleUrls: ['./drag-and-drop-centro-costos.component.css']
})
export class DragAndDropCentroCostosComponent extends BaseComponent {
  ...
  uploadFiles(): void {
    ...
    if (this.fileList.length > 0) {
      ...
      Array.from(this.fileList).forEach((file: File) => {
        this.tasksManager.makeFileRequestCentroDeCostos(file)
          .then((response: any) => {
