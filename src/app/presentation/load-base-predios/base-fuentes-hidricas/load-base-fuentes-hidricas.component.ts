...
@Component({
  selector: 'app-load-base-fuentes-hidricas-component',
  templateUrl: './load-base-fuentes-hidricas.component.html'
})

export class LoadBaseFuentesHidricasComponent extends BaseComponent implements OnInit {

  public hidricasBase: any;
  ...
  public getBasePrediosDocument(): void {
    this.tasksManager.getBasePrediosDocument('2')
      .then((base: any) => {
        this.hidricasBase = base;
      });
  }
}
