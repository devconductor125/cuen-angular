...
@Component({
  selector: 'app-load-base-procesos-erosivos-component',
  templateUrl: './load-base-procesos-erosivos.component.html'
})

export class LoadBaseProcesosErosivosComponent extends BaseComponent implements OnInit {

  public erosionBase: any;
  ...
  public getBasePrediosDocument(): void {
    this.tasksManager.getBasePrediosDocument('3')
      .then((base: any) => {
        this.erosionBase = base;
      });
  }
}
