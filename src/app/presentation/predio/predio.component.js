...
var PredioComponent = (function (_super) {
    __extends(PredioComponent, _super);
    function PredioComponent(messagingService, proceduresManager, tasksManager, router, activatedRoute, geoJsonService, rolesManager, cuencaService) {
    ...
    PredioComponent.prototype.ngOnInit = function () {
    ...
    PredioComponent.prototype.getTask = function () {
        var _this = this;
    ...
    PredioComponent.prototype.getComments = function () {
        var _this = this;
    ...
    PredioComponent.prototype.insertComment = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    PredioComponent.prototype.setDataType = function () {
    ...
    PredioComponent.prototype.getData = function () {
        var _this = this;
        switch (this.task.details.type.id + '') {
            case '1':
    ...
    PredioComponent.prototype.downloadData = function (data) {
        var _this = this;
    ...
    PredioComponent.prototype.getShapeFile = function (geoJson) {
    ...
    PredioComponent.prototype.approveTask = function () {
        var _this = this;
        var componente = this;
    ...
    PredioComponent.prototype.approveTaskOtros = function () {
        var _this = this;
        this.tasksManager.approveTask(this.task.id)
            .then(function () {
            _this.tasksManager.clearObjects();
    ...
    PredioComponent.prototype.approveTaskBuenasP = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.tasksManager.approveTask(this.task.id)
    ...
    PredioComponent.prototype.approveTaskSigGeneracion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
    ...
    PredioComponent.prototype.approveTaskConceptoCoordinacion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
    ...
    PredioComponent.prototype.approveTaskConceptoJuridico = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
    ...
    PredioComponent.prototype.approveTaskMinutaDireccion = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
    ...
    PredioComponent.prototype.approvePropietarioFirma = function () {
        var _this = this;
        var componente = this;
        if (this.hasDocuments) {
            this.conceptoCoor = false;
    ...
    PredioComponent.prototype.approveTaskProgrammer = function () {
        var _this = this;
        var componente = this;
    ...
    PredioComponent.prototype.refreshFiles = function ($event) {
        this.obtenerArchivos();
    };
    //////devolver Tarea
    PredioComponent.prototype.decline = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    PredioComponent.prototype.declineOtros = function () {
        var _this = this;
        this.activatedRoute.paramMap
            .map(function (params) { return +params.get('id') + ''; })
            .subscribe(function (idString) {
    ...
    PredioComponent.prototype.eliminarDoc = function (id, type) {
        var _this = this;
    ...
    PredioComponent.prototype.obtenerArchivos = function () {
        var _this = this;
        this.documents = null;
    ...
    PredioComponent.prototype.returnName = function (nameFile) {
        var nombre = nameFile.split('_');
        return nombre[1];
    };
    PredioComponent.prototype.eventoProgramar = function ($event) {
    ...
    PredioComponent.prototype.solicitarCertificado = function () {
        var _this = this;
    ...
    PredioComponent.prototype.enviarCertificado = function () {
        var component = this;
    ...
    PredioComponent.prototype.cancelarTarea = function () {
    ...
    PredioComponent.prototype.getRoles = function () {
        var component = this;
    ...
    PredioComponent.prototype.getUsers = function () {
        var component = this;
        this.users = [];
        return new Promise(function (resolve) {
    ...
    PredioComponent.prototype.enviarTareaCoordinadorA = function () {
        var _this = this;
...
PredioComponent = __decorate([
    core_1.Component({
        selector: 'cuenca-predio',
...
exports.PredioComponent = PredioComponent;
//# sourceMappingURL=predio.component.js.map