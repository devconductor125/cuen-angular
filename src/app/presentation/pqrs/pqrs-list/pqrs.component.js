...
var PqrsComponent = (function (_super) {
    __extends(PqrsComponent, _super);
    function PqrsComponent(proceduresManager, messagingService, rolesManager, cuencaVerdeService) {
    ...
    PqrsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.messagingService.publish(new messaging_service_1.BusMessage('onRouteChanged', null));
        this.cuencaVerdeService.getAllPqrs()
            .then(function (pqrsList) {
            if (pqrsList instanceof Array) {
                _this.pqrsList = pqrsList;
            }
        })
            .catch();
        this.getUserRoles(this);
    };
    return PqrsComponent;
}(base_component_1.BaseComponent));
PqrsComponent = __decorate([
    core_1.Component({
...
exports.PqrsComponent = PqrsComponent;
//# sourceMappingURL=pqrs.component.js.map