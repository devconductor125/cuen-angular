...
var CreatePqrsComponent = (function (_super) {
    __extends(CreatePqrsComponent, _super);
    function CreatePqrsComponent(activatedRoute, cuencaVerdeService, messagingService, location, proceduresManager, rolesManager, router) {
    ...
    CreatePqrsComponent.prototype.ngOnInit = function () {
        this.messagingService.publish(new messaging_service_1.BusMessage('onRouteChanged', null));
        this.getUserRoles(this);
    };
    CreatePqrsComponent.prototype.ngOnDestroy = function () {
    };
    CreatePqrsComponent.prototype.onGotRoles = function () {
        var _this = this;
    ...
    CreatePqrsComponent.prototype.getDependencies = function () {
        var _this = this;
    ...
    CreatePqrsComponent.prototype.getPqrsTypes = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.pqrsTypes = [];
    ...
    CreatePqrsComponent.prototype.createPqrs = function () {
        var _this = this;
    ...
    CreatePqrsComponent.prototype.sendPqrsResponse = function () {
        var _this = this;
        if (this.pqrs.isValid()) {
    ...
    return CreatePqrsComponent;
}(base_component_1.BaseComponent));
CreatePqrsComponent = __decorate([
    core_1.Component({
...
exports.CreatePqrsComponent = CreatePqrsComponent;
//# sourceMappingURL=create-pqrs.component.js.map