...
var ListActionsComponent = (function (_super) {
    __extends(ListActionsComponent, _super);
    function ListActionsComponent(proceduresManager, tasksManager, router, activatedRoute, rolesManager, messagingService) {
    ...
    ListActionsComponent.prototype.getActionsAll = function () {
        var _this = this;
        this.tasksManager.getActionsAll()
            .then(function (actions) {
            _this.listActions = actions;
            console.log(_this.listActions);
        });
    };
...
exports.ListActionsComponent = ListActionsComponent;
