...
*/
  static blendColors(color1: any, color2: any, percentage: number): String {
    // check input
    ...
    // 5: convert to hex
    color3 = '#' + ColorUtils.intToHex(color3[0]) + ColorUtils.intToHex(color3[1]) + ColorUtils.intToHex(color3[2]);
  ...
  */
  static intToHex(num: any): string {
