...
@Component({
  ...
  templateUrl: './view-budget-contractor.component.html',
  styleUrls: ['./view-budget-contractor.component.css']
})
export class ViewBudgetContractorComponent extends BaseComponent implements OnInit {
  ...
  protected loadProject() {
    ...
    this.activatedRoute.paramMap
      ...
      .subscribe(idString => {
        ...
        this.tasksManager.getBudgetFromProcessContractor(id)
  ...
  // función para retornar el porcentaje de un numero
