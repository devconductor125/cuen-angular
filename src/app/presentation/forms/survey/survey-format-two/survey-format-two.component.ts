...
@Component({
  selector: 'cuenca-survey-format-two',
  templateUrl: './survey-format-two.component.html',
  styleUrls: ['./survey-format-two.component.css']
})

export class SurveyFormatTwoComponent extends BaseComponent implements OnInit {
