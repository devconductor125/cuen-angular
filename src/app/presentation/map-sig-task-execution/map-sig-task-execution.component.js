...
var MapSigTaskExecutionComponent = (function (_super) {
...
], MapSigTaskExecutionComponent.prototype, "fileUploader", void 0);
MapSigTaskExecutionComponent = __decorate([
    core_1.Component({
        selector: 'cuenca-map',
        templateUrl: './map-sig-task-execution.component.html',
        styleUrls: ['./map-sig-task-execution.component.css']
    }),
...
exports.MapComponent = MapSigTaskExecutionComponent;
