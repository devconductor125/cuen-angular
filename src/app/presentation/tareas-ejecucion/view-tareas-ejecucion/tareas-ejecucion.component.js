...
var TareasEjecucionComponent = (function (_super) {
    __extends(TareasEjecucionComponent, _super);
    function TareasEjecucionComponent(cuencaVerdeServices, messagingService, taskManager, proceduresManager, rolesManager) {
        ...
        _this.taskForExecution = [];
        return _this;
    }
    TareasEjecucionComponent.prototype.ngOnInit = function () {
    ...
    TareasEjecucionComponent.prototype.ngOnDestroy = function () {
    };
    TareasEjecucionComponent.prototype.getExecutionTask = function () {
        var _this = this;
    ...
    return TareasEjecucionComponent;
}(base_component_1.BaseComponent));
TareasEjecucionComponent = __decorate([
    core_1.Component({
...
exports.TareasEjecucionComponent = TareasEjecucionComponent;
//# sourceMappingURL=tareas-ejecucion.component.js.map